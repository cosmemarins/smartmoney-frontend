...
const ContratosPendentes = () => {
  ...
  return (
    <Card>
      <CardHeader title='Contratos pendentes' />
            ...
            {data.map((row, index) => (
              <tr key={index} className='border-0'>
                ...
                <td className='pli-2 plb-3'>
                  <div className='flex flex-col'>{row.cliente?.nome}</div>
                </td>
                <td className='pli-2 plb-3'>{row.cliente?.gestor?.nome}</td>
                <td className='pli-2 plb-3'>
