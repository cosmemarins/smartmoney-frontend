...
const DadosBancarios = () => {
  ...
  const dadosBancariosInit = {
    ...
    tipoPoupanca: usuario?.tipoPoupanca,
  ...
  const handleFormSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    salvarDadosBancarios(dadosBancariosEdit)
      .then(respUsuario => {
        ...
        setUsuarioContext({
          ...usuario,
          banco: respUsuario.banco,
          agencia: respUsuario.agencia,
          conta: respUsuario.conta,
          tipoConta: respUsuario.tipoConta,
          tipoPoupanca: respUsuario.tipoPoupanca,
          tipoPix: respUsuario.tipoPix,
          chavePix: respUsuario.chavePix
        })
