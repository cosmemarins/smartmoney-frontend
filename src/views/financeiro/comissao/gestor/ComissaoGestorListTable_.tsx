...
const ComissaoGestorListTable = ({ token, ano, mes }: Props) => {
  //hooks
  ...
  return (
    <>
      <Card>
        <CardHeader title='Minhas Comissões - Resumo Mensal' className='pbe-4' action='Resumo Mensal' />
        <div className='flex justify-between flex-col items-start md:flex-row md:items-center p-6 border-bs gap-4'>
          ...
          <div className='flex flex-col sm:flex-row is-full items-start sm:items-center gap-4'>
            ...
            <Button
              href={`/financeiro/comissao/gestor/${comissaoFilter.token || 'all'}/${
