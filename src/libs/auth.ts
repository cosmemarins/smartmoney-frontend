  ...
  callbacks: {
    ...
    async jwt({ token, user }) {
      if (user) {
        ...
        token.tipoPessoa = user.tipoPessoa
        token.email = user.email
        token.isAdmin = user.isAdmin
        token.idGestor = user.idGestor
        token.tokenGestor = user.tokenGestor
    ...
    async session({ session, token }) {
      if (session.user) {
        ...
        session.user.tipoPessoa = token.tipoPessoa
        session.user.email = token.email
        session.user.idGestor = token.idGestor
        session.user.tokenGestor = token.tokenGestor
